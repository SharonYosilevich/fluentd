#!/usr/bin/env python3
"""
Creates Kibana index pattern and two dashboards:
...
INDEX_PATTERN_ID = "fluentd-index-pattern"
...
def create_index_pattern():
    print("Creating index pattern  fluentd-* ...")
    _req("POST", f"/api/saved_objects/index-pattern/{INDEX_PATTERN_ID}?overwrite=true", {
        "attributes": {"title": "fluentd-*", "timeFieldName": "@timestamp"},
    })
...
def main():
    ...
    print("\n✓  All done!")
    print("\n  HTTP Access Logs →  http://localhost:5601/app/dashboards#/view/dashboard-http-access-logs")
    print("  HTTP Errors      →  http://localhost:5601/app/dashboards#/view/dashboard-errors")
